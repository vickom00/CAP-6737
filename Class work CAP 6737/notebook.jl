...
# ╔═╡ d264b8fc-c74b-4a23-b5b7-b88c99b16ba5
using GameTheory
...
# ╔═╡ 3bc9c326-8697-49ac-8ae6-afcdab2e05e0
# p2 expected payoffs
p2(H|p) = p(1) + (1-p)(-1)
p2(T|p) = p(-1) + (1-p)(1)
...
# ╔═╡ cafdeb83-dfe4-463c-b1bb-9b6fb4d824c2
begin
...
# ╔═╡ cc608393-297b-413d-85d3-0bbeb7aba158
pure_nash(g)

# ╔═╡ 4cbd028d-8c0b-4ba8-bc5f-05d7fbce5ecd
