...
# ╔═╡ ddfc2fa8-5fc4-4f95-983f-62da4867cefe
md"""
#### Project Contributors: Bailey LaRea and Victor Omomola.
"""
...
# ╔═╡ 83f58593-0483-4df7-b8b4-ca4f28b1505d
md"""

This graph is very dense. You cannot make out any communities or find any hubs. Without breaking the network into smaller pieces we are not able to find any identifiable features in it.
...
md"""
Alexis, Ishku Ishku, and Alveena are the thee users with the most amount of edges between them. This is also seen in the betweenness where each of them are in the top four as being the most influential. This set of degrees has the lowest amount compared to Twitter and Facebook. 
"""
...
# ╔═╡ 5bebb936-681b-4216-a0ea-8005169ea1d4
md"""
...
# ╔═╡ 41e40169-37fa-4b66-a7e5-e25c2b298c64
begin
...
# WARNING!!! THE GRAPH CONSUMES A LOT OF MEMORY TO LOAD

# ╔═╡ abf4fcd5-2bf2-4c31-b0d5-2a3ec226738b
md"""
...
# ╔═╡ 26815ec7-7c77-4f7d-9415-c42e1e53e64d
md"""
You can see that Ernie has the second most amount of edges attached to him, which makes sense since he is the most influential user in the network. Engkos Kosasih is also one of the most influential. There is not as high of a degree as Twitter. 
"""
...
# ╔═╡ 157d1172-cf47-44c6-93ac-b080f3c57a9a
md"""
The betweenness centrality means there are not many users that have a strong influence as all of them are around .001. This does mean that they all contribute to liking and sharing posts almost equally. The most influential user is Ernie, but once again there are many users that contribute almost as much as him. 
"""
...
# ╔═╡ ef0fe4a6-dbb1-4982-a844-e0330579ac18
md"""
...
# ╔═╡ 43c660db-8634-4851-9501-9f811eefdd4e
md"""
...
# ╔═╡ a8ba1cf4-0ede-4286-913f-2937ebfaa45e
md"""
...
# ╔═╡ 193cc5ad-162a-4ea2-a1f0-f5d2f3114dff
md"""
There are many users with over 500 edges attached to them meaning they have the possibility of reaching that many users on Twitter. It is possible that the user with the most edges is also the most influential, but it’s also possible that most of those edges could be between the same user or group of users thus making them not influential. 
"""
...
# ╔═╡ 1c4d713c-84cc-403a-9578-6534c56c9b59
md"""
The betweenness centrality is means there are many users that have a strong influence on the network. They act as a bridge to other parts of the network. This is how we are able to tell who the most influential user is. This twitter between table shows that Homer, Ellis and Dililah are part of the most influential in the network.
"""
...
# ╔═╡ 45ee2560-26f7-434d-ab88-af2d828867a4
md"""
...
# ╔═╡ 86c9e487-5cd4-461e-9065-db949676752a
md"""
## Limitations to our Project
"""

# ╔═╡ 5df40ca8-28f8-431f-91b5-89526627308d
md"""
...
# ╔═╡ 425c6347-e555-4cb3-8fee-ff59d2880ab7
md"""
## Final Conclusion
"""

# ╔═╡ 949b757a-9324-4a90-b121-1be35b3d24dc
md"""
There appears to be a correlation to the degree and the strength of the betweenness centrality as to being the most influential. In all cases the highest betweenness user has been towards the top of the degree table. This just shows that the most influential is also the user that has one of the highest amount of edges attached to them. Instagram not only had the smallest network, its users also had the smallest amount of degrees. You can see this trend in Facebook and Instagram too, where the size of the network impacts the degree of the user. 
"""
