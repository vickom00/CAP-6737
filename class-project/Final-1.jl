...
facebook_data = DataFrame(XLSX.readtable("/Users/baileylarea/Downloads/Facebook_Data.xlsx", "Sheet1")...)
...
twitter_data = DataFrame(XLSX.readtable("/Users/baileylarea/Downloads/Twitter_Data.xlsx", "Sheet1")...)
...
instagram_data = DataFrame(XLSX.readtable("/Users/baileylarea/Downloads/Instagram_Data.xlsx", "Sheet1")...)
...
# ╔═╡ cbf6cf31-06b1-4cfd-b5ab-0077e62f37aa
md"""
...
gplot(facebook_graph, layout=stressmajorize_layout) 



# ╔═╡ c7fed7c4-0fc7-47e6-8911-25f9dbf69082
md"""
...
# ╔═╡ c1e39903-58e9-476f-aa80-8d8804167a9e
gplot(facebook_graph,  layout=stressmajorize_layout)
...
# ╔═╡ 7ac92200-4d68-4e64-a7de-83d00a04137f
md"""
...
# ╔═╡ 73e13190-2caa-4b17-8122-8d739efb161f
md"""
